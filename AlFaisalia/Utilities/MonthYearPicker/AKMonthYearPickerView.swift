...
public class AKMonthYearPickerView: UIView {
    ...
    private func getToolBar() -> UIToolbar {
        ...
        customToolbar.clipsToBounds = true//changes
        customToolbar.barStyle     = .blackTranslucent
        customToolbar.barTintColor = barTintColor
        customToolbar.tintColor    = UIColor.white
        customToolbar.layer.cornerRadius = 40//changes
        customToolbar.layer.maskedCorners =  [.layerMinXMinYCorner, .layerMaxXMinYCorner]//changes
